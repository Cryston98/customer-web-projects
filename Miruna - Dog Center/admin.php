...
<body style="background-color: #F0E68C">
    ...
    <div class="container" >
        <a href="adminDeleteAnouncement.php"><button style="width:50%"><?php echo $lang['DELETEall'] ;?></button></a>
        <br><br>
        <a href="updateProfile.php"><button style="width:50%"><?php echo $lang['UPD']; ?></button></a>
        <br><br>
        <a href="updateUserProfile.php"><button style="width:50%"><?php echo $lang['UPDU']; ?></button></a>
        <br><br>
        <a href="confirmAnouncement.php"><button style="width:50%"><?php echo $lang['CONFIRM']; ?></button></a>
    </div>
         <div class="footer">
   	 <div class="container">

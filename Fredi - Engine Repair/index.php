    ...
    <div id="logo">
      ...
      <div id="textHome">
        <p id="text_effect">ENGINE REPAIR<br>Service Auto Premium<br> </p>
         <p style="color:white;"> Te așteptăm la service-ul nostru pentru orice problemă legată de mașina ta.<br> 
          Beneficiezi de Prețul Corect  și Calitate Premium pentru toate serviciile auto oferite</p>
      </div>
